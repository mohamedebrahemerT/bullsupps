        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{shippedaffiliate( $id )}}<sup style="font-size: 20px"></sup></h3>
         ...
         <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{returnedaffiliate( $id )}}<sup style="font-size: 20px"></sup></h3>
         ...
         <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{Receivedaffiliate($id)}}<sup style="font-size: 20px"></sup></h3>
        ...
        <div class="row">
          ...
          <div class="small-box bg-aqua">
            ...
            <div class="inner">
              ...
              <h3>{{NewOrdersaffiliateBalance($id)}}</h3>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <div class="inner">
              ...
              <h3>{{waitshipingaffiliateBalance($id)}}</h3>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{shippedaffiliateBalance($id)}}<sup style="font-size: 20px"></sup></h3>
         ...
         <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{returnedaffiliateBalance($id)}}<sup style="font-size: 20px"></sup></h3>
         ...
         <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{ReceivedaffiliateBalance($id)}}<sup style="font-size: 20px"></sup></h3>
...
<!------------------------------------------------------------------------------------------------------------------------------>
         ...
         <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3>{{Withdrawable($id)}}<sup style="font-size: 20px"></sup></h3>
  ...
  <tbody>
                    ...
                    @foreach(App\affilaiateLinks::where('adminID',$id)->orderBy('id','desc')->get() as $links )
