...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'AfterPaymentorder_product_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'AfterPaymentorder_product_name_ar' , {
        language: '{{session('lang')}}',
});
           ...
           var title_name_en = $('.title_name_en').val();
          var title_name_ar = $('.title_name_ar').val();       
       
          
          var AfterPaymentorder_product_name_en = CKEDITOR.instances.AfterPaymentorder_product_name_en.getData();
          var AfterPaymentorder_product_name_ar = CKEDITOR.instances.AfterPaymentorder_product_name_ar.getData();       
       
   
               $.ajax({
                
              url:'{{ url('admin/AfterPaymentorder_product')}}/{{$AfterPaymentorder_product->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "AfterPaymentorder_product_name_en": AfterPaymentorder_product_name_en,
        "AfterPaymentorder_product_name_ar": AfterPaymentorder_product_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.AfterPaymentorder_product') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.AfterPaymentorder_product_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.AfterPaymentorder_product_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/AfterPaymentorder_product','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.AfterPaymentorder_product.updattabs.AfterPaymentorder_product_name_en')
              @include('Admin.AfterPaymentorder_product.updattabs.AfterPaymentorder_product_name_ar')
        
          @include('Admin.AfterPaymentorder_product.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/AfterPaymentorder_product/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
