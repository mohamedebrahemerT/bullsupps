...
class citiesdatatables extends DataTable
{
    ...
    {
        return cities::query()->with('country_id');
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
                 'name'=> 'cities_name_ar',
                'data'=> 'cities_name_ar',
               'title'=>trans('admin.cities_name_ar'),
              ...
              [
                 'name'=> 'cities_name_en',
                'data'=> 'cities_name_en',
               'title'=>trans('admin.cities_name_en'),

            ],
               [
                 'name'=> 'country_id.countries_name_ar' ,
                'data'=>   'country_id.countries_name_ar' ,
            ...
            [
                 'name'=> 'ShippingRate' ,
                'data'=>   'ShippingRate' ,
               'title'=>trans('admin.ShippingRate'),
