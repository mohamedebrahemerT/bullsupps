...
class BannerTopdatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.BannerTop.btn.edit')

         ->addColumn('delete', 'Admin.BannerTop.btn.delete')

         ->addColumn('checkbox', 'Admin.BannerTop.btn.checkbox')
    ...
    public function query(BannerTop $model)

    {

        return BannerTop::query();
