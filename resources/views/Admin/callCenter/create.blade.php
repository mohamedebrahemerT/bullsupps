 ...
 @push('js')
            <script type="text/javascript">
               ...
               $(document).on('click','.DELET_PRODUCT',function(){
                ...
                $.ajax({
              url:'{{ url('admin/DELET_PRODUCT/'.$callCenter->id ) }}',
              dataType:'json',
              type:'post',
              data:{
                _token:'{{ csrf_token()  }}'
          ...
          $('.DELET_PRODUCT1').html('<h1>'+data.message+'</h1>');
             ...
             $(document).on('click','#save_from_data1',function(){
              ...
              url:'{{ url('admin/callCenter/'.$callCenter->id) }}',
              dataType:'json',
              type:'post',
              data:From_data,
              beforeSend:function(){
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{ trans('admin.addnewREservie') }}</h3>
...
<br> <div class="clearfix"> </div>
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.callCenter')}}</a></li>
   ...
   {!! Form::open(['url'=>url('admin/callCenter/'.$callCenter->id),'files'=>true,'method'=>'put','id'=>'save_from_data' ]) !!}
  ...
  <div class="tab-content">
          ...
          @include('Admin.callCenter.tabs.product_info')
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {{trans('admin.productNAme_is') }}:{{ $callCenter->title  }}
      </div>
      <div class="modal-footer">
          <a href="{{url('admin/callCenter') }}">  <button type="button" class="btn btn-default" >{{trans('admin.leave') }}</button>
            </a>
      </div>
    </div>
