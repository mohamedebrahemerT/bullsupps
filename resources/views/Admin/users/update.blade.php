  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            ...
            <div class="box-body">
                       ...
                       {!! Form::open(array('url' => 'admin/users/'.$user->id,'method'=>'put', 'id' => 'fromdata')) !!}

                     <div class="form-group"> 

                     {{ Form::label('name', trans('admin.username'))  }}

                    {{ Form::text('name',$user->name,['class'=>'form-control'] ,old('name'))  }}
                    ...
                    {{ Form::text('email',$user->email,['class'=>'form-control'],old('email'))  }}
