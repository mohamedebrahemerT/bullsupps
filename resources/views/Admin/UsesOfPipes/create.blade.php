    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.UsesOfPipes_name_es')}}</a></li>

    <li><a data-toggle="tab" href="#menu1"><i class="fa fa-gear"></i> {{trans('admin.UsesOfPipes_name_fr')}}</a></li>

    
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-file"></i> {{trans('admin.UsesOfPipes_name_it')}}</a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-info"></i> {{trans('admin.UsesOfPipes_name_ru')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/UsesOfPipes','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.UsesOfPipes.tabs.UsesOfPipes_name_en')
              @include('Admin.UsesOfPipes.tabs.UsesOfPipes_name_es')
          @include('Admin.UsesOfPipes.tabs.UsesOfPipes_name_fr')
          @include('Admin.UsesOfPipes.tabs.UsesOfPipes_name_it')
          @include('Admin.UsesOfPipes.tabs.UsesOfPipes_name_ru')
          @include('Admin.UsesOfPipes.tabs.photo')
               <div class="form-group"> 
