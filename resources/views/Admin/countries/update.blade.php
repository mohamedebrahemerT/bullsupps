...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{ trans('admin.countries') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                      

{{  Form::open(['url'=>'admin/counteries/'.$countries->id,'method'=>'put','files'=>true] ) }}
                     <div class="form-group"> 
             {{ Form::label('countries_name_ar',trans('admin.countries_name_ar'))  }}
   {{ Form::text('countries_name_ar',$countries->countries_name_ar,['class'=>'form-control'])  }}
                     </div> 
                       <div class="form-group"> 
                     {{ Form::label('countries_name_en', trans('admin.countries_name_en'))  }}
                    {{ Form::text('countries_name_en',$countries->countries_name_en,['class'=>'form-control'])  }}
                     </div> 

                        <div class="form-group"> 
                     {{ Form::label('currency', trans('admin.currency'))  }}
                    {{ Form::text('currency',$countries->currency,['class'=>'form-control'])  }}
                     </div> 
                    ...
                    {{ Form::text('code',$countries->code,['class'=>'form-control'])  }}
                     </div> 
    ...
    {{ Form::label('logo', trans('admin.logo'))  }}
     {{ Form::file('logo',['class'=>'form-control'])  }}
             ...
             <img src="{{Storage::url($countries->logo)}}"  style="width:100px;height:100px  " />
     
                      
     </div> 
                      
                    {{ Form::submit(trans('admin.update'),['class'=>'form-control btn btn-primary'])  }}
                     </div> 
