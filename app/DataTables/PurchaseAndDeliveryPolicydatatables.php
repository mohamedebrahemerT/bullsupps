...
class PurchaseAndDeliveryPolicydatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.PurchaseAndDeliveryPolicy.btn.edit')

         ->addColumn('delete', 'Admin.PurchaseAndDeliveryPolicy.btn.delete')

         ->addColumn('checkbox', 'Admin.PurchaseAndDeliveryPolicy.btn.checkbox')

        ->addColumn('PurchaseAndDeliveryPolicy_name_'.session('lang'), 'Admin.PurchaseAndDeliveryPolicy.btn.PurchaseAndDeliveryPolicy')

        ->addColumn('title_name_'.session('lang'), 'Admin.PurchaseAndDeliveryPolicy.btn.title')
        ...
        ->rawColumns([
            ...
            'edit','delete','checkbox','PurchaseAndDeliveryPolicy_name_'.session('lang'),'title_name_'.session('lang'),
    ...
    public function query(PurchaseAndDeliveryPolicy $model)

    {

        return PurchaseAndDeliveryPolicy::query();
...

    {
        ...
        ['text'=>'<i class="fa fa-plus"></i>'.trans('admin.add'),'className'=>'btn Orange' ,'action'=>"function(){
           ...
           return [
            ...
            [
              ...
              [
                 ...
                 'name'=> 'PurchaseAndDeliveryPolicy_name_'.session('lang'),

                'data'=> 'PurchaseAndDeliveryPolicy_name_'.session('lang'),

               'title'=>trans('admin.PurchaseAndDeliveryPolicy_name_'.session('lang')),
