...
@endif
									...
									<div class="product-single__thumbnails-grid">
										<ul class="product-single__thumbnails" id="ProductThumbs">
												...
												<a href="{{Storage::url($product->photo)}}" class="product-single__thumbnail">
													<img src="{{Storage::url($product->photo)}}" alt="Reprehenderit qui in ea" width="50" height="50">
												</a>

							@if($product->VideoExst == 1) 

												               		  <img src="{{url('/')}}/forentend3/assets/images/vid.png" class="imagvid"  
...
@endif
        		...
        		@foreach($filess as $file)
											...
											<li class="thumb__element" style="width:50px;margin-left:5px">
...
margin-left: -32px;">
 ...
 <a href="{{url('/')}}/{{$ProductFromSamCat->department_name->dep_name_en}}/{{$ProductFromSamCat->admin_idd->TheNameOftheStore}}/{{ $ProductFromSamCat->title_name_en}}/{{ $ProductFromSamCat->alymarketcode }}/{{sha1(time())}}{{ csrf_token() }}{{sha1(time())}}/{{$ProductFromSamCat->id}}" target="_blank">
