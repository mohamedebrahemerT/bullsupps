...
class SellerAccountdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.SellerAccount.btn.edit')
         ->addColumn('delete', 'Admin.SellerAccount.btn.delete')
         ->addColumn('checkbox', 'Admin.SellerAccount.btn.checkbox')
     ...
     */
    public function query(SellerAccount $model)
    {
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
               ...
               'title'=>trans('admin.FirstAndLastName'),
