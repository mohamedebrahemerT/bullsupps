...
@section('content')
 ...
 @push('js')
          ...
          var yearPrize = $('.yearPrize').val();
              ...
              url:'{{ url('admin/BannerTopEN')}}/{{$BannerTopEN->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.BannerTopEN') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/BannerTopEN','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

 
         
        
          @include('Admin.BannerTopEN.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/BannerTopEN/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
