...
@endpush
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{ trans('admin.sizes') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                     fhgfdhfd

                       {{  Form::open(['url'=>'admin/sizes/'.$sizes->id,'method'=>'put','files'=>true] ) }}
        <div class="form-group">
 ...
 <br>
           ...
           {!! Form::select('is_public', [$sizes->is_public =>$sizes->is_public] + ['yes' => trans('admin.yes'),'no'=>trans('admin.no')], null, ['class' => 'form-control']) !!}
 <br>
