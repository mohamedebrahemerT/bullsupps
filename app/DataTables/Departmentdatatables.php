...
class Departmentdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('Department_name_'.session('lang'), 'Admin.departments.btn.Department')
        ->addColumn('title_name_'.session('lang'), 'Admin.departments.btn.title')
