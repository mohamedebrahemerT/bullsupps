...
class WhoWeAredatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.WhoWeAre.btn.edit')

         ->addColumn('delete', 'Admin.WhoWeAre.btn.delete')

         ->addColumn('checkbox', 'Admin.WhoWeAre.btn.checkbox')

        ->addColumn('WhoWeAre_name_'.session('lang'), 'Admin.WhoWeAre.btn.WhoWeAre')

        ->addColumn('title_name_'.session('lang'), 'Admin.WhoWeAre.btn.title')
        ...
        ->rawColumns([
            ...
            'edit','delete','checkbox','WhoWeAre_name_'.session('lang'),'title_name_'.session('lang'),
    ...
    public function query(WhoWeAre $model)

    {

        return WhoWeAre::query();
           ...
           return [
            ...
            [
              ...
              [
                 ...
                 'name'=> 'WhoWeAre_name_'.session('lang'),

                'data'=> 'WhoWeAre_name_'.session('lang'),

               'title'=>trans('admin.WhoWeAre_name_'.session('lang')),
