...
class BannerTopFactorydatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.BannerTopFactory.btn.edit')

         ->addColumn('delete', 'Admin.BannerTopFactory.btn.delete')

         ->addColumn('checkbox', 'Admin.BannerTopFactory.btn.checkbox')
    ...
    public function query(BannerTopFactory $model)

    {

        return BannerTopFactory::query();
