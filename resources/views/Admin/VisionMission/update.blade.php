...
@section('content')
 ...
 @push('js')
            ...
            <script>
                ...
                CKEDITOR.replace( 'VisionMission_name_en' , {

        language: '{{session('lang')}}',

});

                CKEDITOR.replace( 'VisionMission_name_ar' , {
   ...
   var VisionMission_name_ar = CKEDITOR.instances.VisionMission_name_ar.getData();
           ...
           var From_data=$('#save_from_data').serialize();
              ...
              url:'{{ url('admin/VisionMission')}}/{{$VisionMission->id}}',
        ...
        "VisionMission_name_en": VisionMission_name_en,

        "VisionMission_name_ar": VisionMission_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      ...
      <div class="box-header">
       ...
       <h3 class="box-title">{{ trans('admin.VisionMission') }}</h3>
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.VisionMission_name_en')}}</a></li>



       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.VisionMission_name_arr')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/VisionMission','files'=>true,'id'=>'save_from_data'] ) }}

                <div class="tab-content">



        @include('Admin.VisionMission.updattabs.VisionMission_name_en')

              @include('Admin.VisionMission.updattabs.VisionMission_name_ar')

         

          @include('Admin.VisionMission.updattabs.photo')
