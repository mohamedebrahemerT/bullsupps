...
class dep_get_parent_FactoriesController extends Controller
{
    /**
...
return  $city=Form::select('city_id',departmentsFactories::where('parent',request('country_id'))->pluck('dep_name_ar','id'),$select,['class'=>'form-control city_id',"placeholder"=>"........"] );
 ...
 return Form::select('parent',departmentsFactories::where('parent',request('city_id'))->pluck('dep_name_ar','id'),$select,['class'=>'form-control parent',"placeholder"=>"........"] );
