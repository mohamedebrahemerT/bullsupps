...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'RawMaterials_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'RawMaterials_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var RawMaterials_name_en = $('.RawMaterials_name_en').val();
          var RawMaterials_name_ar = $('.RawMaterials_name_ar').val();  
              ...
              url:'{{ url('admin/RawMaterials')}}/{{$RawMaterials->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "RawMaterials_name_en": RawMaterials_name_en,
        "RawMaterials_name_ar": RawMaterials_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.RawMaterials') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.RawMaterials_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.RawMaterials_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/RawMaterials','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.RawMaterials.updattabs.RawMaterials_name_en')
              @include('Admin.RawMaterials.updattabs.RawMaterials_name_ar')
        
          @include('Admin.RawMaterials.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/RawMaterials/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
