...
@section('content')
 ...
 @push('js')
          ...
          var yearPrize = $('.yearPrize').val();
          
       
   
               $.ajax({
                
              url:'{{ url('admin/photoesFactory')}}/{{$photoesFactory->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.photoesFactory') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/photoesFactory','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

    
         
        
          @include('Admin.photoesFactory.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/photoesFactory/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
