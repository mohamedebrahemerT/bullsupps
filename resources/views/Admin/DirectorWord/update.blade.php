...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'DirectorWord_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'DirectorWord_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var DirectorWord_name_en = $('.DirectorWord_name_en').val();
          var DirectorWord_name_ar = $('.DirectorWord_name_ar').val();  
              ...
              url:'{{ url('admin/DirectorWord')}}/{{$DirectorWord->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "DirectorWord_name_en": DirectorWord_name_en,
        "DirectorWord_name_ar": DirectorWord_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.DirectorWord') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.DirectorWord_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.DirectorWord_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/DirectorWord','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.DirectorWord.updattabs.DirectorWord_name_en')
              @include('Admin.DirectorWord.updattabs.DirectorWord_name_ar')
        
          @include('Admin.DirectorWord.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/DirectorWord/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
