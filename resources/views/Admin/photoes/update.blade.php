...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/photoes')}}/{{$photoes->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.photoes') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/photoes','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

    
         
        
          @include('Admin.photoes.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/photoes/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
