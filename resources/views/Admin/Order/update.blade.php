...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'Order_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'Order_name_ar' , {
        language: '{{session('lang')}}',
});
           ...
           var billing_name_on_card = $('.billing_name_on_card').val();
           var billing_discount = $('.billing_discount').val();
           var billing_discount_code = $('.billing_discount_code').val();
           var billing_subtotal = $('.billing_subtotal').val();
           var billing_tax = $('.billing_tax').val();
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Order_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Order','files'=>true,'id'=>'save_from_data'] ) }}
              ...
              @include('Admin.Order.updattabs.Order_name_ar')
        
          @include('Admin.Order.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Order/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
