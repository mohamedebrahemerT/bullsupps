...
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/styles/bootstrap4/bootstrap.min.css">
<link href="{{url('')}}/forentend/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/plugins/slick-1.8.0/slick.css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/styles/responsive.css">
<meta name="viewport" content="width=device-width, initial-scale=1">
       <link rel="stylesheet" href="http://fonts.googleapis.com/earlyaccess/droidarabickufi.css">

<link rel="stylesheet" type="text/css" href="{{url('')}}/forentend/styles/ae-header-rtl.css">
...
<style type="text/css">
  .country-flag {
 background:transparent url(//ae01.alicdn.com/kf/H9f160b429e0548c29e7f24631e8276e58.png) no-repeat
}
.css_flag {
 display:block;
 float:left;
...
.css_af {
 background-image:url(//ae01.alicdn.com/kf/H9f160b429e0548c29e7f24631e8276e58.png);
...
.address-selector .css_flag {
 line-height:14px
}
.address-select-trigger,
.address-selector .address-selector .address-select a {
 width:75px;
 color:#333;
 font-size:12px;
...
.address-selector .address-select a:hover {
 text-decoration:none
}
.address-selector .address-select {
...
.address-selector .address-select-content {
 margin:-1px 0 0;
 padding:0;
 background:#fff;
 overflow:auto;
...
.address-selector .address-select-content ul {
 list-style:none;
 padding:0;
 margin:0
}
.address-selector .address-select-item {
 display:block;
 margin:0;
 padding:11px 10px;
 cursor:pointer;
...
.address-selector .address-select-item:hover {
 color:#fff;
 background:#49f
}
.address-select-item-disabled a,
.address-selector .address-select-item-disabled {
 cursor:not-allowed;
 color:#ccc
}
.address-select-item-disabled a:hover,
.address-selector .address-select-item-disabled:hover {
 background:#fff
}
.address-selector .address-select-item .shipping-text {
 font-size:12px;
 line-height:16px
}
.address-selector .address-select-trigger {
 display:inline-block;
 margin-left:5px;
 padding-right:10px;
...
.address-selector .address-select-trigger::after,
.address-selector .address-select-trigger::before {
 content:'';
 width:9px;
 height:2px;
 background:#999;
...
.address-selector .filter-list-container {
 position:relative;
 margin-top:-4px
}
.address-selector .filter-input {
 width:100%;
 height:32px;
...
.address-selector .address-select-trigger i {
 position:absolute;
 top:0;
 right:15px;
 line-height:28px;
...
.address-selector .address-select-trigger .css_flag {
 margin:8px 0 0 10px;
 text-indent:0
}
.address-selector .address-select-trigger-active {
 border:1px solid #666
}
.address-selector .address-select .address-select-trigger {
 display:block
}
.address-select .address-select-disabled,
.address-selector .address-select-disabled {
 color:#aaa;
 cursor:not-allowed
}
#addr_loading_mask {
 display:inline-block;
 background:url(//i.alicdn.com/ae-wholesale-ui/common/img/loading-middle.gif) no-repeat center center rgba(0,0,0,.03);
...
.ng-switcher [data-role=city],
.ng-switcher [data-role=country],
.ng-switcher [data-role=province] {
 display:block;
 margin:13px 0 0 0;
 width:100%!important;
 border-radius:4px;
...
.ng-switcher .address-select-trigger .css_flag {
 font-size:14px;
 color:#000;
 margin-top:12px
}
.ng-switcher .address-select-trigger {
 background-position-y:-182px
}
.ng-switcher .address-select {
 width:100%!important;
 height:auto!important
}
.ng-switcher .address-selector {
 width:100%;
 margin-top:7px;
 position:relative;
 min-height:40px
}
.ng-switcher .switcher-shipto>.label {
 padding-top:1px
}
.ng-switcher .address-selector .shipping-text {
 display:inline-block;
 max-width:156px;
 line-height:15px;
 overflow:hidden;
...
.ng-switcher .address-selector .css_flag {
 padding-left:30px
}
.ng-switcher .address-selector .address-select-content {
 padding:5px 0;
 max-height:150px
}
.ng-switcher .address-selector .address-select-item {
 padding:7px 13px
}
.ng-switcher .address-select-item-hover,
.ng-switcher .address-selector .address-select-item:hover {
 background:#f9f9f9;
 color:#000
}
.ng-switcher .address-selector .address-select-trigger {
 color:#000;
 box-sizing:border-box
}
.ng-switcher .address-selector .address-select-trigger .shipping-text {
 padding-top:13px;
 text-indent:0
}
.ng-switcher .address-select-trigger .css_flag .shipping-text {
 padding-top:2px
}
.ng-switcher .address-selector .address-select-trigger::after,
.ng-switcher .address-selector .address-select-trigger::before {
 top:18px
}
.ng-switcher[data-role=region-pannel] .switcher-sub {
 width:261px
}
.ng-switcher .address-selector .address-select-trigger:hover {
 color:#000
}
.ng-switcher .switcher-sub .switcher-currency.item {
 padding-top:0
}
.ng-switcher .switcher-currency>.label {
 padding:12px 0
}
...
.ng-switcher .switcher-currency-c>span::before {
 content:'';
 width:9px;
 height:2px;
 background:#999;
...
.ng-switcher .switcher-currency-c .search-container {
 position:absolute;
 z-index:1;
 margin-top:-4px;
 width:100%
}
.ng-switcher .switcher-currency-c .search-currency {
 width:100%;
 height:32px;
 box-sizing:border-box;
 outline:0;
...
.ng-switcher .switcher-currency-c .select-item a:hover {
 color:#000
}
.ng-switcher .switcher-currency-c .chang-border,
.ng-switcher .switcher-currency-c .chang-border:focus {
 border:1px solid #666
}
.ng-switcher .switcher-currency-c .search-container .seach {
 width:12px;
 height:12px;
 border:1px solid #ccc;
 display:block;
...
.ng-switcher .switcher-currency-c .search-container .seach::before {
 content:'';
 width:8px;
 height:2px;
 background:#ccc;
...
.nav-global .ng-switcher-language .switcher-language:after {
 ...
 height:5px;
 overflow:hidden;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -350px -50px
}
.nav-global .ng-switcher-language .switcher-sub {
 width:240px;
 padding:10px 0 0
}
.nav-global .ng-switcher-language .switcher-sub li a[data-site=isr] {
 direction:rtl
}
...
.ui-autocomplete .store-name:after {
 content:'';
 position:absolute;
 top:8px;
 right:0;
 ...
 height:15px;
 overflow:hidden;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -4px -250px
}
...
.ui-autocomplete .store-logo-no-exist {
 display:inline-block;
 height:18px;
 background:url(/ae-header/20200213195227/buyer/common/img/ic_store.png);
 width:18px;
 vertical-align:middle
}
.member-level {
...
.s-member-level {
 ...
 font-weight:700;
 color:#fff;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -200px 0
}
.sm-level-A0 {
...
.aliexpress-notice .site-notice-container {
 position:relative;
 text-align:left
}
.aliexpress-notice .notice-content {
 padding:10px 50px 10px 0;
 line-height:16px;
 font-size:12px
}
.aliexpress-notice .notice-content a {
 text-decoration:underline;
 color:#333
}
.aliexpress-notice .notice-operate {
 position:absolute;
 right:0;
 top:50%;
 margin-top:-19px;
...
.aliexpress-notice .notice-operate a {
 display:inline-block;
 margin-left:10px;
...
.aliexpress-notice .notice-operate a:hover {
 text-decoration:none
}
.aliexpress-notice .notice-operate a.notice-agree {
 background-color:#ff4747;
 border-color:#ff4747;
 color:#fff
}
.aliexpress-notice .notice-operate a.notice-agree:hover {
 opacity:.92
}
.aliexpress-notice .notice-close {
 position:absolute;
 right:0;
 top:50%;
 margin-top:-12px;
 ...
 overflow:hidden;
 text-indent:-999rem;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -597px -196px
}
.site-download-header a {
 display:block;
 width:100%
}
.site-download-header img {
 width:100%
}
.top-lighthouse {
 position:relative;
...
.nav-global .ng-sub.unfold .ng-sub-title,
.nav-global .ng-sub:hover .ng-sub-title {
 background-color:#fff;
 margin:-1px -1px 0 -1px;
 height:35px;
 border:1px solid #ccc;
...
.nav-global .ng-sub.unfold .ng-sub-list,
.nav-global .ng-sub:hover .ng-sub-list {
 display:block;
 border:1px solid #ccc;
 box-shadow:0 3px 5px 0 rgba(51,51,51,.3)
}
...
.nav-global .global-seller-menu .ng-sub-list {
 width:auto
}
...
.nav-global .ng-setting-proxy {
 display:none
}
.logo a,
.site-logo .logo-base {
 background-image:url(../public/forentend2/img/logo.jpg);
...
@media (-webkit-min-device-pixel-ratio:2),(min-resolution:2dppx) {
 .logo a,
 .site-logo .logo-base {
  background-image:url(/ae-header/20200213195227/buyer/common/img/icons_x2-s09540fde2d.png);
  background-size:240px 3122px;
  background-position:0 -28px
 }
}
.inside-page-logo-mall .ae-logo-base,
.mall-header .aliexpress-logo {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.inside-page-logo-mall .mall-logo-base,
.mall-header .mall-logo {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-appliances .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-camera .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-computer .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-headset .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-iphone .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-kitchen .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-office .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-tv .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-watch .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-wellness .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.new-categories-main.mall-categories .cl-mall-allproducts .cate-name span:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.header .nav-wishlist>a:before {
 background-image:url(../public/forentend/images/icons-s6358434378.png);
...
.header-navigation li.nav-sub>a:after,
.nav-global .ng-sub-title:after,
.nav-global .ng-switcher .switcher-info:after,
...
.header-navigation li.nav-sub:hover>a:after,
.nav-global .ng-sub:hover .ng-sub-title:after,
.nav-global .ng-switcher.active .switcher-info:after {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.mall-site-service a.full-satisfaction:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.mall-site-service a.days-return:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.mall-site-service a.time-limit-off:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.mall-categories .categories-title:after {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
 background-position:0 -1908px;
 background-repeat:no-repeat
}
...
.top-lighthouse-mall .ng-login a:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.top-lighthouse-mall .ng-add-wishlist a:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.top-lighthouse-mall .ng-add-cart a:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.site-user-account .user-account-info:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.site-user-account:hover .user-account-info:before {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.site-user-account .user-account-info:after {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.site-user-account:hover .user-account-info:after {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.tmall-header .tmall-header-left .tmall-logo {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
...
.mall-lighthouse .ae-logo .logo-link {
 background-image:url(/ae-header/20200213195227/buyer/common/img/icons-s6358434378.png);
 background-position:0 -97px;
 background-repeat:no-repeat
}
...
.categories-main .categories-content-title a:hover {
 color:#ff4747;
 text-decoration:none
}
...
.sub-cate-items dt:after {
 ...
 height:13px;
 overflow:hidden;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -3000px -50px;
 vertical-align:top
}
.sub-cate-items dt a {
 max-width:190px;
...
.header-categories:after {
 ...
 height:40px;
 overflow:hidden;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -500px -50px
}
...
.header-categories .balloon-arrow {
 ...
 height:10px;
 overflow:hidden;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -600px -50px;
 z-index:10
}
...
.sub-cate-row-mall .sub-cate-items dt,
.sub-cate-row-mall .sub-cate-items dt a {
 color:#FF0036
}
.mall-brands-list {
 white-space:normal;
...
.browser-upgrade-tip .browser-icon,
.browser-upgrade-tip .message .view-more,
.browser-upgrade-tip .title {
 background:url(/ae-header/20200213195227/buyer/common/img/browser-upgrade-sprite.png) no-repeat
}
.browser-upgrade-tip .title {
 font-size:14px;
 font-weight:700;
...
.browser-upgrade-tip .close {
 ...
 top:6px;
 right:6px;
 background:url(/ae-header/20200213195227/buyer/common/img/ui-window-close.png) no-repeat 0 -2px
}
...
.browser-upgrade-dialog .list li span.browser-ie {
 background-image:url(/ae-header/20200213195227/buyer/common/img/ie-icon.jpg)
}
.browser-upgrade-dialog .list li span.browser-chrome {
 background-image:url(/ae-header/20200213195227/buyer/common/img/chrome-icon.jpg)
}
.browser-upgrade-dialog .list li span.browser-firefox {
 background-image:url(/ae-header/20200213195227/buyer/common/img/firefox-icon.jpg)
}
.browser-upgrade-dialog .list li span.browser-opera {
 background-image:url(/ae-header/20200213195227/buyer/common/img/opera-icon.jpg)
}
...
.header .searchbar-form .search-button {
 ...
 width:50px;
 height:40px;
 background:#e62e04 url(../public/forentend/images/header-sprite.png) no-repeat -587px 8px;
...
.me-header .searchbar-form .search-button {
 ...
 border-left:none;
 background:#fff url(/ae-header/20200213195227/buyer/common/img/me-icons.png) no-repeat center -388px
}
...
.header .nav-wishlist-ctn,
.header .nav-wishlist>a:after {
 top:70px
}
...
.me-header .nav-wishlist-ctn,
.me-header .nav-wishlist>a:after {
 top:60px
}
...
.header .user-account-info:after,
.header .user-account-main {
 top:70px
}
.header .user-account-info {
 height:75px
...
.me-header .user-account-info:after,
.me-header .user-account-main {
 top:60px
}
.me-header .user-account-info {
 height:65px
...
.flyout-user-signIn .flyout-signIn-type .nus-icon {
 ...
 height:26px;
 vertical-align:middle;
 background:url(/ae-header/20200213195227/buyer/common/img/header-sprite.png) no-repeat -400px 0
}
...
.header-special-container .hm-left {
 height:105px
}
.header-special-container .hm-right {
 height:105px
}
.header-special-container .hot-words {
 height:16px;
 overflow:hidden;
 margin-top:7px
}
.header-special-container .hot-words a {
 position:relative;
 float:left;
 padding:0 10px;
 line-height:16px;
...
.header-special-container .hot-words a:before {
 position:absolute;
 left:0;
 top:2px;
 content:'';
...
.header-special-container .hot-words a:first-child {
 padding-left:0
}
.header-special-container .hot-words a:first-child:before {
 display:none
}
.header-special-container .hot-words a:hover {
 color:#F60
}
.header-special-container .hot-words .highlight {
 color:#E62E04
}
.top-lighthouse {
 direction:rtl
...
.cl-item-unfold .cate-name span:before {
 right:11px
}
.cl-item-unfold .cate-name a.c-name-link {
 margin-left:0;
...
.top-selection .top-selection-slider {
    padding: 0 10px 12px;
}
...
.top-selection .product-list .product-item {
    width: 25%;
}
...
top-selection .product-list .pro-note {
    margin-top: 4px;
}
.product-list li a {
    position: relative;
