    ...
    <div class="col-md-12">
        ...
        <div class="well">
            ...
            <div class="form-horizontal">
                 ...
                 <form method="post" action="{{url('/')}}/my-ordersGet">  
                     	@csrf
            <div class="form-horizontal">

                <div class="form-group">

                    <label for="inputOrderTrackingID" class="col-sm-2 control-label"> {{trans('admin.Orderid')}}  </label> 

                        <div class="col-sm-10">

         <input type="text" name="inputOrderTrackingID" class="form-control" id="inputOrderTrackingID" value="" placeholder="{{trans('admin.put your order id here')}}">
             ...
             <button type="submit" id="shopGetOrderStatusID" class="btn btn-success">{{trans('admin.Getstatus')}} </button>
...
@endphp
        ...
        <ol class="progtrckr" data-progtrckr-steps="5"   style="margin-right: 30%;">

    <li class="progtrckr-done">{{trans('admin.Underway')}}</li><!--

 --><li class="progtrckr-todo">{{trans('admin.itischarged')}}</li><!--

 --><li class="progtrckr-todo">{{trans('admin.Received')}}</li>
   ...
   @endif
    ...
    <li class="progtrckr-done">{{trans('admin.confirmed')}}</li><!--
 ...
 --><li class="progtrckr-done">{{trans('admin.itischarged')}}</li><!--
 ...
 --><li class="progtrckr-done">{{trans('admin.Received')}}</li>
