...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'SellerAccount_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'SellerAccount_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var SellerAccount_name_en = $('.SellerAccount_name_en').val();
          var SellerAccount_name_ar = $('.SellerAccount_name_ar').val();  
              ...
              url:'{{ url('admin/SellerAccount')}}/{{$SellerAccount->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "SellerAccount_name_en": SellerAccount_name_en,
        "SellerAccount_name_ar": SellerAccount_name_ar,
     ...
     <div class="box">
      <div class="box-header">
       ...
       {{  Form::open(['url'=>'admin/SellerAccount','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.SellerAccount.updattabs.SellerAccount_name_en')
        ss
        
          @include('Admin.SellerAccount.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/SellerAccount/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
