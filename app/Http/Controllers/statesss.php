...

{
...

    {
        ...
        if (request()->ajax()) 
           ...
           if (session('lang') == 'ar' ) 
           {
                $output=Form::select('city_id',cities::where('country_id',request('country_id'))->pluck('cities_name_ar','id'),$select,['class'=>'form-control city_id',"placeholder"=>"........"] );
           }
           else
           {
   ...
   if (session('lang') == 'ar' ) 
   {
     return Form::select('stat_id',states::where('city_id',request('city_id'))->pluck('states_name_ar','id'),$select,['class'=>'form-control',"placeholder"=>"........"] );
