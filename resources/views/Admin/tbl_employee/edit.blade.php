...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{ trans('admin.PeriodicPrograms') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                      

                       {{  Form::open(['url'=>'admin/PeriodicPrograms/'.$PeriodicPrograms->id,'method'=>'put','files'=>true] ) }}
        <div class="form-group">
            {!! Form::label('title',trans('admin.title')) !!}
            {!! Form::text('title',$PeriodicPrograms->title,['class'=>'form-control']) !!}
        </div>
