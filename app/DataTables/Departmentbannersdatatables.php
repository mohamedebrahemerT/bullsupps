...
class Departmentbannersdatatables extends DataTable
...

{
...

    {
        ...
        ->addColumn('edit', 'Admin.Departmentbanners.btn.edit')



         ->addColumn('delete', 'Admin.Departmentbanners.btn.delete')



         ->addColumn('checkbox', 'Admin.Departmentbanners.btn.checkbox')
    ...
    public function query(Departmentbanners $model)
...

    {
        ...
        return Departmentbanners::query();
