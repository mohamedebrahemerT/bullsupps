...
class tagsdatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.tags.btn.edit')
         ...
         ->addColumn('checkbox', 'Admin.tags.btn.checkbox')
        ->addColumn('tags_name_'.session('lang'), 'Admin.tags.btn.tags')
        ->addColumn('title_name_'.session('lang'), 'Admin.tags.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','tags_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'tags_name_'.session('lang'),
                'data'=> 'tags_name_'.session('lang'),
               'title'=>trans('admin.tags_name_'.session('lang')),
