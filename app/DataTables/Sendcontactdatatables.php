...
class Sendcontactdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
         ...
         ->addColumn('delete', 'Admin.Sendcontact.btn.delete')
         ->addColumn('checkbox', 'Admin.Sendcontact.btn.checkbox')
     ...
     */
    public function query(Sendcontact $model)
    {
        return Sendcontact::query()->orderBy('id','desc');
    }
