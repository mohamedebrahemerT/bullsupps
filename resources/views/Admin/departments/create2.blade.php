...
@endpush
 ...
 @push('js')
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      @if($department->country_id) 
      

                    $.ajax({
       type:'GET',
       url:'{{ url('admin/dep_get_parent') }}',
       data:{country_id:'{{ $department->country_id }}',select:'{{ $department->city_id }}'},
       dataType: "html",
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'department_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'department_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var department_name_en = $('.department_name_en').val();
          var department_name_ar = $('.department_name_ar').val();  
          ...
          url:'{{ url('admin/departments')}}/{{$department->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.department') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.department_name_en')}}</a></li>
     ...
     {{  Form::open(['url'=>'admin/departments','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

 
          @include('Admin.departments.updattabs.department_name_en')
        
          @include('Admin.departments.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/department/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
