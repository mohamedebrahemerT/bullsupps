...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'AfterPyment_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'AfterPyment_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var AfterPyment_name_en = CKEDITOR.instances.AfterPyment_name_en.getData();
          var AfterPyment_name_ar = CKEDITOR.instances.AfterPyment_name_ar.getData();       
       
   
               $.ajax({
                
              url:'{{ url('admin/AfterPyment')}}/{{$AfterPyment->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "AfterPyment_name_en": AfterPyment_name_en,
        "AfterPyment_name_ar": AfterPyment_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.AfterPyment') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.AfterPyment_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.AfterPyment_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/AfterPyment','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.AfterPyment.updattabs.AfterPyment_name_en')
              @include('Admin.AfterPyment.updattabs.AfterPyment_name_ar')
        
          @include('Admin.AfterPyment.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/AfterPyment/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
