...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'SendSms_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'SendSms_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var SendSms_name_ar = $('.SendSms_name_ar').val();  
          var number = $('.number').val();  
              ...
              url:'{{ url('admin/SendSms')}}/{{$SendSms->id}}',
        ...
        "_token": "{{ csrf_token() }}",
        "number": number,
        "SendSms_name_ar": SendSms_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.SendSms') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.SendSms_name_en')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/SendSms','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.SendSms.updattabs.SendSms_name_en')
              @include('Admin.SendSms.updattabs.SendSms_name_ar')
        ...
        <div class="form-group"> 
             ...
             <div class="form-group"> 
                    ...
                    <button type="button" class="btn btn-primary form-control" id="save_from_data1"><i class="fa fa-envelope">  <i class="fa fa-envelope fa-spinner loading-save-c hidden"></i></i> {{trans('admin.save_continue2')}}</button>
