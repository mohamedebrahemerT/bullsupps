...
class zonesdatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.zones.btn.edit')

         ->addColumn('delete', 'Admin.zones.btn.delete')

         ->addColumn('checkbox', 'Admin.zones.btn.checkbox')

      

        ->addColumn('title_name_'.session('lang'), 'Admin.zones.btn.title')
        ...
        ->rawColumns([
            ...
            'edit','delete','checkbox','title_name_'.session('lang'),
    ...
    public function query(zones $model)
