...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
            ...
            @isset($monthllySalary)



               المرتب الشهري هذا الموظف هو بناء علي الحضور والغياب  =   <h1> {{$monthllySalary}} {{trans('admin.pound')}}</h1>
...
@endisset
    ...
    {!! Form::open(['id'=>'fromdata','url'=>'admin/tbl_employee/destroy/all','method'=>'delete']) !!}
