  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_BannerTopFactory/img/".$BannerTopFactory->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_BannerTopFactory/img/".$BannerTopFactory->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
           ...
           return (fmock = file.previewElement) != null ? fmock.parentNode.removeChild(file.previewElement) : void 0;
            ...
            init:function()
            {
                ...
                @if (!empty($BannerTopFactory->photo))
               var mock={
                name:'{{ $BannerTopFactory->id }}',
                size:'',
                type:'',
                id:' ',
               };
               this.emit('addedfile',mock);
this.options.thumbnail.call(this,mock,"{{Storage::url($BannerTopFactory->photo)}}" );
               $('.dz-progress').remove();
               @endif
  ...
  $(document).ready(function(){
         $('#dropzone_file_uploads').dropzone({
            ...
            url:'{{ url("admin/BannerTopFactory/img/".$BannerTopFactory->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:15,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/BannerTopFactory_delete_img")}}',
                data:{
           ...
           return (fmock = file.previewElement) != null ? fmock.parentNode.removeChild(file.previewElement) : void 0;
            ...
            init:function()
            {
                 @foreach ($BannerTopFactory->filesss()->get() as $file) 
 ...
 <hr>
          <h4 style="text-align: center;">{{trans('admin.subBannerTopFactory')}}</h4>
