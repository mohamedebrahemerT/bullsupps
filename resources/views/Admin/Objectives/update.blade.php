...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'Objectives_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'Objectives_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();   
               ...
               var Objectives_name_ar = CKEDITOR.instances.Objectives_name_ar.getData();
                    var Objectives_name_en = CKEDITOR.instances.Objectives_name_en.getData();


        
               $.ajax({
                
              url:'{{ url('admin/Objectives')}}/{{$Objectives->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "Objectives_name_en": Objectives_name_en,
        "Objectives_name_ar": Objectives_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.Objectives') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active">
        ...
        {{trans('admin.Objectives_name_en')}} 
      </a>
    </li>

       <li>
        <a data-toggle="tab" href="#department">
          <i class="fa fa-circle"></i> {{trans('admin.Objectives_name_arr')}}</a>
        </li>
       ...
       {{  Form::open(['url'=>'admin/Objectives','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.Objectives.updattabs.Objectives_name_en')
              @include('Admin.Objectives.updattabs.Objectives_name_ar')
        
          @include('Admin.Objectives.updattabs.photo')
               <div class="form-group"> 
