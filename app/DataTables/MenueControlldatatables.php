...
class MenueControlldatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.MenueControll.btn.edit')
         ->addColumn('delete', 'Admin.MenueControll.btn.delete')
         ->addColumn('checkbox', 'Admin.MenueControll.btn.checkbox')
     ...
     */
    public function query(MenueControll $model)
    {
        return MenueControll::query()->with('admin_idd');
    }
