...
class SendSmsdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.SendSms.btn.edit')
         ->addColumn('delete', 'Admin.SendSms.btn.delete')
         ->addColumn('checkbox', 'Admin.SendSms.btn.checkbox')
        ->addColumn('SendSms_name_'.session('lang'), 'Admin.SendSms.btn.SendSms')
       

        

        ->rawColumns([
            'edit','delete','checkbox','SendSms_name_'.session('lang')]);
     ...
     */
    public function query(SendSms $model)
    {
        return SendSms::query();
    }
      ...
      public function html()
    {
        ...
        ['text'=>'<i class="fa fa-plus"></i>'.trans('admin.newsend'),'className'=>'btn Orange' ,'action'=>"function(){
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'SendSms_name_'.session('lang'),
                'data'=> 'SendSms_name_'.session('lang'),
               'title'=>trans('admin.SendSms_name_'.session('lang')),
