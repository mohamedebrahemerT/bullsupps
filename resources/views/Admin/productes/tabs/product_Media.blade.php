...
this.options.thumbnail.call(this,mock,"{{Storage::url($productes->photo)}}" );
  ...
  $(document).ready(function()
         ...
         $('#dropzone_offerphoto').dropzone({
            url:'{{ url("admin/update_imgofferphoto_dropzon_product/img/".$productes->id) }}',
...

            {
              ...
              $.ajax({
                ...
                url:'{{ url("delete_imgofferphoto_dropzon_product/".$productes->id)}}',
...
this.options.thumbnail.call(this,mock,"{{Storage::url($productes->offerphoto)}}" );
