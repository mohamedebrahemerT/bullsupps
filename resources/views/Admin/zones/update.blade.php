 ...
 @push('js')
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.zones') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.zones_name_en')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/zones','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.zones.updattabs.zones_name_en')
        
          @include('Admin.zones.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/zones/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
