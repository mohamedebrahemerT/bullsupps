...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/OrderShareWithAllVendor') }}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.OrderShareWithAllVendor') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.OrderShareWithAllVendor_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.OrderShareWithAllVendor_name_es')}}</a></li>

    <li><a data-toggle="tab" href="#menu1"><i class="fa fa-gear"></i> {{trans('admin.OrderShareWithAllVendor_name_fr')}}</a></li>

    
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-file"></i> {{trans('admin.OrderShareWithAllVendor_name_it')}}</a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-info"></i> {{trans('admin.OrderShareWithAllVendor_name_ru')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/OrderShareWithAllVendor','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.OrderShareWithAllVendor.tabs.OrderShareWithAllVendor_name_en')
              @include('Admin.OrderShareWithAllVendor.tabs.OrderShareWithAllVendor_name_es')
          @include('Admin.OrderShareWithAllVendor.tabs.OrderShareWithAllVendor_name_fr')
          @include('Admin.OrderShareWithAllVendor.tabs.OrderShareWithAllVendor_name_it')
          @include('Admin.OrderShareWithAllVendor.tabs.OrderShareWithAllVendor_name_ru')
          @include('Admin.OrderShareWithAllVendor.tabs.photo')
               <div class="form-group"> 
