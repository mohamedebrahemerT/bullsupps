...
class Objectivesdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.Objectives.btn.edit')
         ->addColumn('delete', 'Admin.Objectives.btn.delete')
         ->addColumn('checkbox', 'Admin.Objectives.btn.checkbox')
        ->addColumn('Objectives_name_'.session('lang'), 'Admin.Objectives.btn.Objectives')
        ->addColumn('title_name_'.session('lang'), 'Admin.Objectives.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','Objectives_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(Objectives $model)
    {
        return Objectives::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'Objectives_name_'.session('lang'),
                'data'=> 'Objectives_name_'.session('lang'),
               'title'=>trans('admin.Objectives_name_'.session('lang')),
