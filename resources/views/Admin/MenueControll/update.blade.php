...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'MenueControll_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'MenueControll_name_ar' , {
        language: '{{session('lang')}}',
});
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/MenueControll')}}/{{$MenueControll->id}}',
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.MenueControll')}}</a></li>

       <li ><a data-toggle="tab" href="#MenueControllen"><i class="fa fa-info"></i> {{trans('admin.MenueControll')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/MenueControll','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.MenueControll.updattabs.MenueControll_name_en')
        @include('Admin.MenueControll.updattabs.MenueControll_name_ar')
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/MenueControll/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
