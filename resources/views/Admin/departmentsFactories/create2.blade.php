 ...
 @push('js')
        ...
        language: '{{session('lang')}}',
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var departmentsFactories_name_en = $('.departmentsFactories_name_en').val();
          var departmentsFactories_name_ar = $('.departmentsFactories_name_ar').val();  
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.departmentsFactories') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.departmentsFactories_name_en')}}</a></li>
     ...
     {{  Form::open(['url'=>'admin/departmentsFactoriess','files'=>true,'id'=>'save_from_data'] ) }}
          ...
          @include('Admin.departmentsFactories.updattabs.departmentsFactories_name_en')
        
          @include('Admin.departmentsFactories.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/departmentsFactories/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
