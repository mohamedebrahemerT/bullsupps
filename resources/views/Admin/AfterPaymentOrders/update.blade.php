...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'AfterPaymentOrders_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'AfterPaymentOrders_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var AfterPaymentOrders_name_en = CKEDITOR.instances.AfterPaymentOrders_name_en.getData();
          var AfterPaymentOrders_name_ar = CKEDITOR.instances.AfterPaymentOrders_name_ar.getData();       
       
   
               $.ajax({
                
              url:'{{ url('admin/AfterPaymentOrders')}}/{{$AfterPaymentOrders->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "AfterPaymentOrders_name_en": AfterPaymentOrders_name_en,
        "AfterPaymentOrders_name_ar": AfterPaymentOrders_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.AfterPaymentOrders') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.AfterPaymentOrders_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.AfterPaymentOrders_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/AfterPaymentOrders','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.AfterPaymentOrders.updattabs.AfterPaymentOrders_name_en')
              @include('Admin.AfterPaymentOrders.updattabs.AfterPaymentOrders_name_ar')
        
          @include('Admin.AfterPaymentOrders.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/AfterPaymentOrders/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
