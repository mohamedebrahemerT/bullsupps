...
{{ Form::select('country_id',App\countries::pluck('countries_name_en','id'),old('country_id'),['class'=>'form-control',"placeholder"=>"........"] )  }}
                     </div> 


                      <div class="form-group"> 
                     {{ Form::label('ShippingRate', trans('admin.ShippingRate'))  }}
                    {{ Form::text('ShippingRate',old('ShippingRate'),['class'=>'form-control'])  }}
                     </div> 
                    ...
                    {{ Form::submit(trans('admin.cities_add'),['class'=>'form-control btn btn-primary'])  }}
                     </div> 
