...
class Jobsdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.Jobs.btn.edit')
         ->addColumn('delete', 'Admin.Jobs.btn.delete')
         ->addColumn('checkbox', 'Admin.Jobs.btn.checkbox')
        ->addColumn('Jobs_name_'.session('lang'), 'Admin.Jobs.btn.Jobs')
        ->addColumn('title_name_'.session('lang'), 'Admin.Jobs.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','Jobs_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'Jobs_name_'.session('lang'),
                'data'=> 'Jobs_name_'.session('lang'),
               'title'=>trans('admin.Jobs_name_'.session('lang')),
