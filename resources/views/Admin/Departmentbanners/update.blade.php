...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/Departmentbanners')}}/{{$Departmentbanners->id}}',
      ...
      <div class="box-header">
       ...
       <div class="box-body">
          ...
          <ul class="validate_message">
            ...
            <li class="active"><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
               ...
               <form action="{{ url('admin/Departmentbanners')}}/{{$Departmentbanners->id}}" method="post" enctype="multipart/form-data">


      {{ csrf_field() }}
      @include('Admin.Departmentbanners.updattabs.photo')

                <div class="form-group"> 
            {!! Form::select('catname', [$Departmentbanners->catname=> $Departmentbanners->catname] + ['بنرات صغيره
' => 'بنرات صغيره','بنرات كبيره'=>'بنرات كبيره'  ,  'بنرات رئيسية'=>'بنرات رئيسية' ], null, ['class' => 'form-control']) !!}
                     </div> 


      <button type="submit" class="btn btn-primary form-control"  ><i class="fa fa-save"> </i> {{trans('admin.save_continue')}}</button>
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Departmentbanners/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
