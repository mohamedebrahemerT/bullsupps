...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
       ...
       {!! Form::open(['url'=> 'admin/attribute_values/'.$attribute_values->id,'method'=>'put']) !!}



                  <div class="form-group">
      {!! Form::label('attributes',trans('admin.attributes')) !!}

        <select class="form-control" name="attribute_id">
         @foreach(App\Models\attributes::get() as $attribute)
          <option @if($attribute->id == $attribute_values->attribute_id) selected @endif
           value="{{ $attribute->id}}">
           {{ $attribute->name_en}}
          </option>
          @endforeach
    ...
    <div class="form-group">
      {!! Form::label('value_ar',trans('admin.value_ar')) !!}
      {!! Form::text('value_ar',$attribute_values->value_ar,['class'=>'form-control']) !!}
    </div>
    <div class="form-group">
      {!! Form::label('value_en',trans('admin.value_en')) !!}
      {!! Form::text('value_en',$attribute_values->value_en,['class'=>'form-control']) !!}
    </div>
