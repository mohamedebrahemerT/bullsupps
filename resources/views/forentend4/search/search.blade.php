...
<div class="breadcrumbs">
  ...
  <div class="container">
      ...
      <ul class="breadcrumb">
                ...
                <li><a href="{{url('/')}}">نتائج البحث </a></li>

                <li><a href="{{url('/')}}/title={{$query}}">  {{$query}}</a></li>
...
">
    ...
    margin-right: 0px;
">
   <span ><span class="value"> {{$Most->price_offer }}</span> <span class="currency medium">{{trans('admin.LE')}}</span></span></span>

          <span class="jsx-4251264678 preReductionPrice" style="    color: rgb(178, 187, 210);
"><span style="text-decoration: line-through;"><span class="value">{{$Most->price }} </span> <span class="currency null">{{trans('admin.LE')}}</span></span></span></p>
...
<span><span class="value">{{$Most->price }} </span> <span class="currency null">{{trans('admin.LE')}}</span></span></span>
</p>
