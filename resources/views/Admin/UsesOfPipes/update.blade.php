...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'UsesOfPipes_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'UsesOfPipes_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var UsesOfPipes_name_en = $('.UsesOfPipes_name_en').val();
          var UsesOfPipes_name_ar = $('.UsesOfPipes_name_ar').val();  
              ...
              url:'{{ url('admin/UsesOfPipes')}}/{{$UsesOfPipes->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "UsesOfPipes_name_en": UsesOfPipes_name_en,
        "UsesOfPipes_name_ar": UsesOfPipes_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.UsesOfPipes') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.UsesOfPipes_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.UsesOfPipes_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/UsesOfPipes','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.UsesOfPipes.updattabs.UsesOfPipes_name_en')
              @include('Admin.UsesOfPipes.updattabs.UsesOfPipes_name_ar')
        
          @include('Admin.UsesOfPipes.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/UsesOfPipes/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
