    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.tags_name_es')}}</a></li>

    <li><a data-toggle="tab" href="#menu1"><i class="fa fa-gear"></i> {{trans('admin.tags_name_fr')}}</a></li>

    
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-file"></i> {{trans('admin.tags_name_it')}}</a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-info"></i> {{trans('admin.tags_name_ru')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/tags','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.tags.tabs.tags_name_en')
              @include('Admin.tags.tabs.tags_name_es')
          @include('Admin.tags.tabs.tags_name_fr')
          @include('Admin.tags.tabs.tags_name_it')
          @include('Admin.tags.tabs.tags_name_ru')
          @include('Admin.tags.tabs.photo')
               <div class="form-group"> 
