...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'PurchaseAndDeliveryPolicy_name_en' , {

        language: '{{session('lang')}}',

});

                CKEDITOR.replace( 'PurchaseAndDeliveryPolicy_name_ar' , {
        ...
        language: '{{session('lang')}}',
          ...
          var title_name_ar = $('.title_name_ar').val();  
                 ...
                 var PurchaseAndDeliveryPolicy_name_ar = CKEDITOR.instances.PurchaseAndDeliveryPolicy_name_ar.getData();

                    var PurchaseAndDeliveryPolicy_name_en = CKEDITOR.instances.PurchaseAndDeliveryPolicy_name_en.getData();
              ...
              url:'{{ url('admin/PurchaseAndDeliveryPolicy')}}/{{$PurchaseAndDeliveryPolicy->id}}',
        ...
        "PurchaseAndDeliveryPolicy_name_en": PurchaseAndDeliveryPolicy_name_en,

        "PurchaseAndDeliveryPolicy_name_ar": PurchaseAndDeliveryPolicy_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      ...
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.PurchaseAndDeliveryPolicy_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/PurchaseAndDeliveryPolicy','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.PurchaseAndDeliveryPolicy.updattabs.PurchaseAndDeliveryPolicy_name_en')

              @include('Admin.PurchaseAndDeliveryPolicy.updattabs.PurchaseAndDeliveryPolicy_name_ar')

        

          @include('Admin.PurchaseAndDeliveryPolicy.updattabs.photo')
