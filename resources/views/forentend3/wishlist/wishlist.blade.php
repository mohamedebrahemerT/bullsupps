  ...
  <div id="html-section-cart-template" class="html-section" style="background-color:#fff">
        <div id="CartSection">
          ...
          <div class="wrapper">
            ...
            <h2> {{ Cart::instance('saveForLater')->count() }} :{{trans('admin.y32')}}</h2>
            @endif
...
{{trans('admin.sizes')}} : {{$item->model->size }} {{$item->model->size_idd->name_ar }}<br>
@endif

  @if(session('lang')=='en')
 
{{trans('admin.colors')}} : {{$item->model->color_idd->name_en }}/
{{trans('admin.sizes')}} : {{$item->model->size }} {{$item->model->size_idd->name_en }}<br>
...
@endif
     ...
     <a href=""    class="cart-options" id="switchToCart" aria-expanded="true">
  <span style="display: none;">{{ $item->rowId }}</span><span style="font-size:30px;color:#eb6625"> <i class="fa fa-cart-plus" aria-hidden="true"></i></span></a> 
  ...
  <span style="display: none;">{{ $item->rowId }}</span><span style="font-size:30px;color: red"> <i class="fa fa-trash" style="font-size:30px;color:#eb6625;"></i></span></a> 
                ...
                @endforeach
                          ...
                          @else
                             ...
                             &nbsp;&nbsp;   <h3>{{trans('admin.ynhave')}}</h3>
                        
                         
                             

                         <a href="{{ route('shop.index') }}" class="btn cart__checkout">
