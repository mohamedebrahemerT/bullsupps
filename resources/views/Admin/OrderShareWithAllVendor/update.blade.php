...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'OrderShareWithAllVendor_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'OrderShareWithAllVendor_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var OrderShareWithAllVendor_name_en = $('.OrderShareWithAllVendor_name_en').val();
          var OrderShareWithAllVendor_name_ar = $('.OrderShareWithAllVendor_name_ar').val();  
              ...
              url:'{{ url('admin/OrderShareWithAllVendor')}}/{{$OrderShareWithAllVendor->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "OrderShareWithAllVendor_name_en": OrderShareWithAllVendor_name_en,
        "OrderShareWithAllVendor_name_ar": OrderShareWithAllVendor_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.vendorrescit')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/OrderShareWithAllVendor','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.OrderShareWithAllVendor.updattabs.OrderShareWithAllVendor_name_en')
              
        
          @include('Admin.OrderShareWithAllVendor.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/OrderShareWithAllVendor/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
