...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'WhoWeAre_name_en' , {

        language: '{{session('lang')}}',

});

                CKEDITOR.replace( 'WhoWeAre_name_ar' , {
        ...
        language: '{{session('lang')}}',
          ...
          var title_name_ar = $('.title_name_ar').val();  
                 ...
                 var WhoWeAre_name_ar = CKEDITOR.instances.WhoWeAre_name_ar.getData();
                    var WhoWeAre_name_en = CKEDITOR.instances.WhoWeAre_name_en.getData();
              ...
              url:'{{ url('admin/WhoWeAre')}}/{{$WhoWeAre->id}}',
        ...
        "WhoWeAre_name_en": WhoWeAre_name_en,

        "WhoWeAre_name_ar": WhoWeAre_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      ...
      <div class="box-header">
       ...
       {{  Form::open(['url'=>'admin/WhoWeAre','files'=>true,'id'=>'save_from_data'] ) }}
