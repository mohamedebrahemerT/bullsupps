...
<div id="del_admin{{ $id }}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(['route'=>['withdrawFromTotalMoney.destroy',$id],'method'=>'delete']) !!}
      <div class="modal-body">
        <h4>{{ trans('admin.delete_this',['name'=> session('lang') == 'ar'?$TheAmountToBeWithdrawn:$TheAmountToBeWithdrawn ]) }}</h4>
      </div>
