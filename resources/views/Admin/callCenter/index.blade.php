  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">{{ trans('admin.allresiervation') }}</h3>
    ...
    {!! Form::open(['id'=>'fromdata','url'=>'admin/callCenter/destroy/all','method'=>'delete']) !!}
       ...
       <div class="row">
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header">
              ...
              <h4 class="box-title"> {{trans('admin.scsenter')}} <i class="fa fa-search"></i></h4>
            ...
            <div class="box-body">
               ...
               {!! Form::open(array('url' => 'admin/callCenterSearchAll','method'=>'post', 'id' => 'fromdata')) !!}
            ...
            {!! Form::label('start_at',trans('admin.start_att')) !!}



            {!! Form::text('start_at',old('start_at'),['class'=>'form-control datetpicker','autocomplete'=>'off']) !!}
            ...
            {!! Form::label('end_at',trans('admin.end_att')) !!}



            {!! Form::text('end_at',old('end_at'),['class'=>'form-control datetpicker','autocomplete'=>'off']) !!}
         ...
         <div class="form-group col-md-3 col-lg-3 col-sm-3">
            ...
            {!! Form::label('end_at',trans('admin.presshere')) !!} <br>
             ...
             <input class="btn btn-success" type="submit" name="" value="{{trans('admin.search')}}"> 
