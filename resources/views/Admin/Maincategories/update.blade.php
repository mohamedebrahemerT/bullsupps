...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'Maincategories_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'Maincategories_name_ar' , {
        language: '{{session('lang')}}',
});
           ...
           var Maincategories_name_en = $('.Maincategories_name_en').val();
           var Maincategories_name_ar = $('.Maincategories_name_ar').val();
              ...
              url:'{{ url('admin/Maincategories')}}/{{$Maincategories->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "Maincategories_name_en": Maincategories_name_en,
        "Maincategories_name_ar": Maincategories_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.Maincategories') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Maincategories_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Maincategories_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Maincategories','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.Maincategories.updattabs.Maincategories_name_en')
              @include('Admin.Maincategories.updattabs.Maincategories_name_ar')
        
          @include('Admin.Maincategories.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Maincategories/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
