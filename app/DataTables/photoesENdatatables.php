...
class photoesENdatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.photoesEN.btn.edit')

         ->addColumn('delete', 'Admin.photoesEN.btn.delete')

         ->addColumn('checkbox', 'Admin.photoesEN.btn.checkbox')
    ...
    public function query(photoesEN $model)

    {

        return photoesEN::query();
