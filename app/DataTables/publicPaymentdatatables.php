...
class publicPaymentdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.publicPayment.btn.edit')
         ->addColumn('delete', 'Admin.publicPayment.btn.delete')
         ->addColumn('checkbox', 'Admin.publicPayment.btn.checkbox')
     ...
     */
    public function query(publicPayment $model)
    {
        return publicPayment::query()->with('admin_idd');
    }
           ...
           return [
            ...
            [
             ...
             [
                'name'=> 'RentValue',
                'data'=> 'RentValue',
                'title'=>trans('admin.RentValue'),

            ],
             [
                'name'=> 'admin_id',
                'data'=> 'admin_idd.name',
                'title'=>trans('admin.admin_idd'),
