  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_BannerTopEN/img/".$BannerTopEN->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_BannerTopEN/img/".$BannerTopEN->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
...
this.options.thumbnail.call(this,mock,"{{Storage::url($BannerTopEN->photo)}}" );
               $('.dz-progress').remove();
               @endif
  ...
  $(document).ready(function(){
         $('#dropzone_file_uploads').dropzone({
            ...
            url:'{{ url("admin/BannerTopEN/img/".$BannerTopEN->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:15,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/BannerTopEN_delete_img")}}',
                data:{
           ...
           return (fmock = file.previewElement) != null ? fmock.parentNode.removeChild(file.previewElement) : void 0;
            ...
            init:function()
            {
                 @foreach ($BannerTopEN->filesss()->get() as $file) 
 ...
 <hr>
          <h4 style="text-align: center;">{{trans('admin.subBannerTopEN')}}</h4>
