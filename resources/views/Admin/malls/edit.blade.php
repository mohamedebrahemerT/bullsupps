 ...
 @endpush
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
       {!! Form::open(['url'=>'admin/malls/'.$mall->id,'method'=>'put','files'=>true ]) !!}
   ...
   <div class="form-group">
     ...
     <div class="form-group">
        ...
        {!! Form::select('country_id',App\countries::pluck('countries_name_en','id'),old('country_id'),['class'=>'form-control']) !!}
     </div>
