         ...
         <script type="text/javascript">
          ...
          '<div class="col-sm-4 col-sm-4 col-md-4 col-lg-4">'+
             '{!! Form::label('input_key',trans('admin.input_key1')) !!}'+
            '{!! Form::text('input_key[]','',['class'=>'form-control']) !!}'+

         '</div>'+

         '<div class="col-sm-4 col-sm-4 col-md-4 col-lg-4">'+
            ' {!! Form::label('input_value',trans('admin.input_value1')) !!} '+
...
<div id="department" class="tab-pane fade">
      <h3>{{trans('admin.product_adtional_info1')}}</h3>

         <div class="div_inpute col-sm-12 col-sm-12 col-md-12 col-lg-12">
          @foreach($cities->other_data_R()->get() as $data)
         <div>
          <div class="col-sm-4 col-sm-4 col-md-4 col-lg-4">
             {!! Form::label('input_key',trans('admin.input_key1')) !!}
