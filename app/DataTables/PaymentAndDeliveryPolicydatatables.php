...
class PaymentAndDeliveryPolicydatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.PaymentAndDeliveryPolicy.btn.edit')

         ->addColumn('delete', 'Admin.PaymentAndDeliveryPolicy.btn.delete')

         ->addColumn('checkbox', 'Admin.PaymentAndDeliveryPolicy.btn.checkbox')

        ->addColumn('PaymentAndDeliveryPolicy_name_'.session('lang'), 'Admin.PaymentAndDeliveryPolicy.btn.PaymentAndDeliveryPolicy')

        ->addColumn('title_name_'.session('lang'), 'Admin.PaymentAndDeliveryPolicy.btn.title')
        ...
        ->rawColumns([
            ...
            'edit','delete','checkbox','PaymentAndDeliveryPolicy_name_'.session('lang'),'title_name_'.session('lang'),
    ...
    public function query(PaymentAndDeliveryPolicy $model)

    {

        return PaymentAndDeliveryPolicy::query();
           ...
           return [
            ...
            [
              ...
              [
                 ...
                 'name'=> 'PaymentAndDeliveryPolicy_name_'.session('lang'),

                'data'=> 'PaymentAndDeliveryPolicy_name_'.session('lang'),

               'title'=>trans('admin.PaymentAndDeliveryPolicy_name_'.session('lang')),
