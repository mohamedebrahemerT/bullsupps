...
@endpush
 ...
 @push('js')
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      @if($departmentsFactories->country_id) 
      

                    $.ajax({
       type:'GET',
       url:'{{ url('admin/dep_get_parentFactories') }}',
       data:{country_id:'{{ $departmentsFactories->country_id }}',select:'{{ $departmentsFactories->city_id }}'},
       dataType: "html",
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'departmentsFactories_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'departmentsFactories_name_ar' , {
        language: '{{session('lang')}}',
});
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/departmentsFactoriess')}}/{{$departmentsFactories->id}}',
...
"></i>
              ...
              <h3 class="box-title">{{trans('admin.WhoWeAre_name_arr')}}</h3>
              <!-- tools box -->
              <div class="pull-right box-tools">
 ...
 <!-------------------------------------------------------------------------------->
       ...
       {{  Form::open(['url'=>'admin/departmentsFactoriess','files'=>true,'id'=>'save_from_data'] ) }}
        <div class="form-group">
            {!! Form::label('dep_name_ar',trans('admin.dep_name_ar')) !!}
            {!! Form::text('dep_name_ar',$departmentsFactories->dep_name_ar,['class'=>'form-control']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('dep_name_en',trans('admin.dep_name_en')) !!}
            {!! Form::text('dep_name_en',$departmentsFactories->dep_name_en,['class'=>'form-control']) !!}
        </div>
...
{{ Form::select('country_id',App\departmentsFactories::where('parent',null)->pluck('dep_name_ar','id'),$departmentsFactories->country_id,['class'=>'form-control country_id',"placeholder"=>"........"] )  }}
                     </div> 
 ...
 <label class="priceprice hidden">{{trans('admin.priceguid')}}</label>
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('description',$departmentsFactories->description,['class'=>'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('keyword',trans('admin.keyword')) !!}
            {!! Form::textarea('keyword',$departmentsFactories->keyword,['class'=>'form-control']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('icon',trans('admin.icon')) !!}
            {!! Form::file('icon',['class'=>'form-control']) !!}
            
            @if(!empty($departmentsFactories->icon) and Storage::has($departmentsFactories->icon))
             <img src="{{ Storage::url($departmentsFactories->icon) }}" style="width:100px;height: 100px;">
            @endif
        </div>
         <div class="form-group"> 
