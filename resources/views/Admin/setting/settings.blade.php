...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.stiteSettings') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/setting_store','files'=>true] ) }}
       <div class="form-group col-sm-2 col-md-2 col-lg-2"> 
       {{ Form::label('namear', trans('admin.nameofsitearbic'))  }}
       {{ Form::text('namear',settings()->namear,['class'=>'form-control'])  }}
      </div> 
      <div class="form-group col-sm-2 col-md-2 col-lg-2"> 
     {{ Form::label('nameen', trans('admin.nameofsiteenglish'))  }}
     {{ Form::text('nameaen',settings()->nameaen,['class'=>'form-control'])  }}
     </div>    
  ...
  <option value="en">{{ trans('admin.en')}}</option>
    ...
    {{ Form::label('siteflag', trans('admin.siteflag'))  }}
     ...
     @endif                
      ...
      <div class="form-group col-sm-2 col-md-2 col-lg-2"> 
    {{ Form::label('sitesymol', trans('admin.sitesymol'))  }}
    ...
    @if(!empty(settings()->sitesymol))
     ...
     {{ Form::label('sitesdiscreption', trans('admin.sitesdiscreption'))  }}
  {{ Form::textarea('sitesdiscreption',settings()->sitesdiscreption,['class'=>'form-control'])  }}

        </div> 
<div class="form-group col-sm-4 col-md-4 col-lg-4"> 
{{ Form::label('sitemeta', trans('admin.sitemeta'))  }}
  {{ Form::textarea('sitemeta',settings()->sitemeta,['class'=>'form-control'])  }}
        </div> 
     
               <div class="form-group col-sm-4 col-md-4 col-lg-4"> 
  {{ Form::label('maintenance', trans('admin.maintenance'))  }}
  {{ Form::textarea('maintenance', settings()->maintenance,['class'=>'form-control'])  }}
        </div>


  <div class="form-group col-sm-12 col-md-12 col-lg-12"> 
 {{ Form::label('status', trans('admin.status'))  }}
 {!! Form::select('status',[ "open" => trans('admin.sopen'),"close"
=>trans('admin.sclose') ],settings()->status, ['class' => 'form-control']) !!}
        </div> 
     ...
     {{ Form::text('address_en',settings()->address_en,['class'=>'form-control'])  }}
       ...
       <div class="form-group col-sm-2 col-md-2 col-lg-2"> 
    {{ Form::label('profile', trans('admin.profile'))  }}
     {{ Form::file('profile',old('profile'),['class'=>'form-control'])  }}
   
    @if(!empty(settings()->profile))
     <img src="{{Storage::url(settings()->profile) }}" style="width:50px;height:50px">
     @endif
     </div> 

       <div class="form-group col-sm-2 col-md-2 col-lg-2"> 
    {{ Form::label('siteflag_ar', trans('admin.siteflag_ar'))  }}
     {{ Form::file('siteflag_ar',old('siteflag_ar'),['class'=>'form-control'])  }}
   
    @if(!empty(settings()->siteflag_ar))
     <img src="{{Storage::url(settings()->siteflag_ar) }}" style="width:50px;height:50px">
     @endif
     </div> 
