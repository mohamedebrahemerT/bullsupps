...
<?php
    $lat = !empty($user_address->lat) ? $user_address->lat : '25.206801726395895';
    $lng = !empty($user_address->lng) ? $user_address->lng : '55.271889686584466';
...
@endsection
  ...
  <a href="{{url('/')}}/Add_New_Address">
                                ...
                                <h5 class="mb-0">
                  <img class="back-arrow pe-3" src="{{url('/')}}/assets/images/Back_arrow.svg" alt="">{{trans('admin.Back to Address')}}</h5>
</a>
                            </div>

       <form  method="post" action="{{url('/')}}/edit_New_Address_Map">
       @csrf 
    ...
    <input type="hidden" value="{{ $lng }}" id="lng" name="lng">
        ...
        {!! Form::text('address',$user_address->address,['class'=>'form-control address']) !!}
                            </div>
