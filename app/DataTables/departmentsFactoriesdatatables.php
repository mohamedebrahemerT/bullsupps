...
class departmentsFactoriesdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.departmentsFactories.btn.edit')
         ->addColumn('delete', 'Admin.departmentsFactories.btn.delete')
         ->addColumn('checkbox', 'Admin.departmentsFactories.btn.checkbox')
        ->addColumn('Department_name_'.session('lang'), 'Admin.departmentsFactories.btn.Department')
        ->addColumn('title_name_'.session('lang'), 'Admin.departmentsFactories.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','Department_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(departmentsFactories $model)
    {
        return departmentsFactories::query();
    }
