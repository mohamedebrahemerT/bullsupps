...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'admin_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'admin_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          $('.sucess_message').html('<h1>'+data.message+'</h1>').removeClass('hidden');
             ...
             @endpush
              ...
              <script type="text/javascript">
                $(document).on('click','#save_from_data2',function(){

                 

                   var x=$('#save_from_data2 span').text();
        ...
        "id":{{$admin->id}},
              ...
              beforeSend:function(){
                    ...
                    $('#save_from_data2').css({backgroundColor: 'green'});
                    $("#save_from_data2 span").text("يحق له الشات ");
              ...
              success:function(data){
                 ...
                 if (data.status==true)
                  {
                    $('#save_from_data2').css({backgroundColor: 'red'});
 ...
 <span  class="alert alert-denger">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.admin') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/admins','files'=>true,'id'=>'save_from_data'] ) }}

                <div class="tab-content">

        @include('Admin.admins.updattabs.admin_name_en')
        
        
          @include('Admin.admins.updattabs.photo')
