...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
       ...
       {!! Form::open(['url'=> 'admin/attributes/'.$attributes->id,'method'=>'put']) !!}
    <div class="form-group">
      {!! Form::label('name_ar',trans('admin.name_ar')) !!}
      {!! Form::text('name_ar',$attributes->name_ar,['class'=>'form-control']) !!}
    </div>
    <div class="form-group">
      {!! Form::label('name_en',trans('admin.name_en')) !!}
      {!! Form::text('name_en',$attributes->name_en,['class'=>'form-control']) !!}
    </div>
