...
@section('content')
 ...
 @push('js')
          ...
          var yearPrize = $('.yearPrize').val();
              ...
              url:'{{ url('admin/photoesEN')}}/{{$photoesEN->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.photoesEN') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/photoesEN','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

    
         
        
          @include('Admin.photoesEN.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/photoesEN/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
