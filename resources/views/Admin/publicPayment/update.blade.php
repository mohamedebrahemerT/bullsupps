...
@section('content')
 ...
 @push('js')
          ...
          var end_at = $('.end_at').val();  
              ...
              url:'{{ url('admin/publicPayment')}}/{{$publicPayment->id}}',
     ...
     <div class="box">
      <div class="box-header">
       ...
       {{  Form::open(['url'=>'admin/publicPayment','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.publicPayment.updattabs.publicPayment_name_en')
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/publicPayment/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
