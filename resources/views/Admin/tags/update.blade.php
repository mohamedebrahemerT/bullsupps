...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'tags_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'tags_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var tags_name_en = $('.tags_name_en').val();
          var tags_name_ar = $('.tags_name_ar').val();  
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "tags_name_en": tags_name_en,
        "tags_name_ar": tags_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.tags') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.tags_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.tags_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/tags','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.tags.updattabs.tags_name_en')
              @include('Admin.tags.updattabs.tags_name_ar')
        
          @include('Admin.tags.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/tags/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
