...
@push('js')
 ...
 <div class="container">
   <h3 align="center">{{trans('admin.ImportExcelFile')}}</h3>
    <br />
   @if(count($errors) > 0)
    <div class="alert alert-danger">
                {{trans('admin.UploadValidationError')}}         
   ...
   <form method="post" enctype="multipart/form-data" action="{{ url('/import_excel/import') }}">
    ...
    <div class="form-group">
     <table class="table">
      <tr>
       <td width="40%" align="right"><label>{{trans('admin.SelectFileforUpload')}} </label></td>
       <td width="30">
        <input type="file" name="select_file" />
       </td>
       <td width="30%" align="left">
        <input type="submit" name="upload" class="btn btn-primary" value="{{trans('admin.Upload')}}">
       </td>
      </tr>
      <tr>
       <td width="40%" align="right"></td>
       <td width="30"><span class="text-muted">{{trans('admin.typeoffile')}} .xls, .xslx  </span></td>
       ...
       {{  Form::open(['url'=>'admin/SendSms','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">
                  <input type="hidden" name="GroupSendSms" value="1" class="GroupSendSms">
                	<label>{{trans('admin.smstext')}}</label>
...
@endif
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/SendSms/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
             ...
             <div class="form-group"> 
                    ...
                    <button type="button" class="btn btn-primary form-control" id="save_from_data1"><i class="fa fa-envelope">  <i class="fa fa-envelope fa-spinner loading-save-c hidden"></i></i> {{trans('admin.save_continue3')}}</button>
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
     <h3 class="panel-title">{{trans('admin.uploadnum')}}</h3>
    </div>
