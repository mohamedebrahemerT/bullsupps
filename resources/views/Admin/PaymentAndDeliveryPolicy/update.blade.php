...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'PaymentAndDeliveryPolicy_name_en' , {

        language: '{{session('lang')}}',

});

                CKEDITOR.replace( 'PaymentAndDeliveryPolicy_name_ar' , {
    ...
    var PaymentAndDeliveryPolicy_name_ar = CKEDITOR.instances.PaymentAndDeliveryPolicy_name_ar.getData();

                    var PaymentAndDeliveryPolicy_name_en = CKEDITOR.instances.PaymentAndDeliveryPolicy_name_en.getData();
              ...
              url:'{{ url('admin/PaymentAndDeliveryPolicy')}}/{{$PaymentAndDeliveryPolicy->id}}',
        ...
        "PaymentAndDeliveryPolicy_name_en": PaymentAndDeliveryPolicy_name_en,

        "PaymentAndDeliveryPolicy_name_ar": PaymentAndDeliveryPolicy_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      ...
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.PaymentAndDeliveryPolicy_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/PaymentAndDeliveryPolicy','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.PaymentAndDeliveryPolicy.updattabs.PaymentAndDeliveryPolicy_name_en')

              @include('Admin.PaymentAndDeliveryPolicy.updattabs.PaymentAndDeliveryPolicy_name_ar')

        

          @include('Admin.PaymentAndDeliveryPolicy.updattabs.photo')
