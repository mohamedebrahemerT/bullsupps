...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'Jobs_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'Jobs_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
                  ...
                  var Jobs_name_en = $('.Jobs_name_en').val();
          var Jobs_name_ar = $('.Jobs_name_ar').val();      
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "Jobs_name_en": Jobs_name_en,
        "Jobs_name_ar": Jobs_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.Jobs') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Jobs_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Jobs_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Jobs','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.Jobs.updattabs.Jobs_name_en')
              @include('Admin.Jobs.updattabs.Jobs_name_ar')
        
          @include('Admin.Jobs.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Jobs/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
