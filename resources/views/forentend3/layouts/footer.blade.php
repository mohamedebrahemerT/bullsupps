			...
			<a href="{{url('/')}}/login" data-mfp-src="#LoginModal">
							...
							<input type="email" name="contact[email]" id="Email" class="input-group__field newsletter__input" value="" placeholder="{{trans('admin.enter')}}" style="border-radius:8px 0px 0px 8px;" size="4">
												<span class="input-group__btn">
													<button type="submit" class="btn newsletter__submit" name="commit" id="Subscribe" style="border-radius:0px 8px 8px 0px ">{{trans('admin.Subscription')}}</button>
												</span>
											</div>
										</form>
									</div>
...
font-weight: 700;">
	...
	<div class="combo-icons medium-down--hide">
		<div id="float-saleoff" title="{{trans('admin.SpecialDeals')}}">
			<a href="{{url('/')}}/SaleOff">
				<i class="fa fa-gift" aria-hidden="true"></i>
			</a>
		</div>
		<div id="float-wishlist" title="{{trans('admin.MyWishlist')}}">
			<a href="{{url('/')}}/wishlist">
				<i class="fa fa-heart" aria-hidden="true"></i>
				<span class="number">
					<span class="wlnumber">{{ Cart::instance('saveForLater')->count() }} </span>
				</span>
			</a>
		</div>
		<div id="float-compare" title="{{trans('admin.MyCompare')}}">
			<a href="{{url('/')}}/cart">
				<i class="fa fa-shopping-cart" aria-hidden="true"></i>
				<span class="number">
					<span class="cpnumber" style="margin-left: -11px;
...
function showSlides5050() {
  var i;
  var slides = document.getElementsByClassName("showSlides5050");
  var dots = document.getElementsByClassName("dot5050");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides5050, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides6060() {
  var i;
  var slides = document.getElementsByClassName("showSlides6060");
  var dots = document.getElementsByClassName("dot6060");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides6060, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides7070() {
  var i;
  var slides = document.getElementsByClassName("showSlides7070");
  var dots = document.getElementsByClassName("dot7070");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides7070, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides8080() {
  var i;
  var slides = document.getElementsByClassName("showSlides8080");
  var dots = document.getElementsByClassName("dot8080");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides8080, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides9090() {
  var i;
  var slides = document.getElementsByClassName("showSlides9090");
  var dots = document.getElementsByClassName("dot9090");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides9090, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides100100() {
  var i;
  var slides = document.getElementsByClassName("showSlides100100");
  var dots = document.getElementsByClassName("dot100100");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides100100, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides200200() {
  var i;
  var slides = document.getElementsByClassName("showSlides200200");
  var dots = document.getElementsByClassName("dot200200");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides200200, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides300300() {
  var i;
  var slides = document.getElementsByClassName("showSlides300300");
  var dots = document.getElementsByClassName("dot300300");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides300300, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides400400() {
  var i;
  var slides = document.getElementsByClassName("showSlides400400");
  var dots = document.getElementsByClassName("dot400400");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides400400, 2000); // Change image every 2 seconds
}
</script>
...
function showSlides500500() {
  var i;
  var slides = document.getElementsByClassName("showSlides500500");
  var dots = document.getElementsByClassName("dot500500");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(showSlides500500, 2000); // Change image every 2 seconds
}
</script>
...
function mySlides80() {
  var i;
  var slides = document.getElementsByClassName("mySlides80");
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides80, 10000); // Change image every 2 seconds
}
</script>
...
function mySlides81() {
  var i;
  var slides = document.getElementsByClassName("mySlides81");
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides81, 10000); // Change image every 2 seconds
}
</script>
...
function mySlides82() {
  var i;
  var slides = document.getElementsByClassName("mySlides82");
  var dots = document.getElementsByClassName("dot82");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides82, 10000); // Change image every 2 seconds
}
</script>
...
function mySlides83() {
  var i;
  var slides = document.getElementsByClassName("mySlides83");
  var dots = document.getElementsByClassName("dot83");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides83, 10000); // Change image every 2 seconds
}
</script>
...
function mySlides84() {
  var i;
  var slides = document.getElementsByClassName("mySlides84");
  var dots = document.getElementsByClassName("dot84");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides84, 10000); // Change image every 2 seconds
}
</script>
...
function mySlides85() {
  var i;
  var slides = document.getElementsByClassName("mySlides85");
  var dots = document.getElementsByClassName("dot85");
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";  
  }
  slideIndex++;
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " active";
  setTimeout(mySlides85, 10000); // Change image every 2 seconds
}
</script>
