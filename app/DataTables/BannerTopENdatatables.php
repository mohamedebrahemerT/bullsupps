...
class BannerTopENdatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.BannerTopEN.btn.edit')

         ->addColumn('delete', 'Admin.BannerTopEN.btn.delete')

         ->addColumn('checkbox', 'Admin.BannerTopEN.btn.checkbox')
    ...
    public function query(BannerTopEN $model)

    {

        return BannerTopEN::query();
