...
class AfterPaymentOrdersdatatables extends DataTable

{
...

    {
        ...
        return datatables($query)
         ...
         ->addColumn('delete', 'Admin.AfterPaymentOrders.btn.delete')

         ->addColumn('checkbox', 'Admin.AfterPaymentOrders.btn.checkbox')
    ...
    public function query(AfterPaymentOrders $model)

    {

        return AfterPaymentOrders::query();
