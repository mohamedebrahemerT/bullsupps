		...
		<div class="container">
            ...
            @endif
                ...
                @foreach (Cart::content() as $item)
                        ...
                        <a title="Remove this item" class="remove" ><span style="display: none;">{{ $item->rowId }}</span><span style="font-size:30px;color: red">×</span></a> 

                            <form action="#" method="POST">
                                {{ csrf_field() }}

                               
        <a class="cart-options" id="saveForLater"><span style="display: none;">{{ $item->rowId }}</span>Save for Later </a>
            ...
            @endif
						...
						<div class="order_total">
							<div class="order_total_content text-md-right">
								...
								<div class="order_total_amount">{{ presentPrice(Cart::Total()) }}</div>
							</div>
						</div>
						...
						<div class="cart_buttons">
							<a href="{{ route('shop.index') }}" class="button cart_button_clear">{{trans('admin.ContinueShopping')}}</a>
						 
							<a href="{{ route('Checkout.index') }}" class="button cart_button_checkout" >proceed to checkout</a>
