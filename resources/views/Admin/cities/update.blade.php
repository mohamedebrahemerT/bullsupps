...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/cities')}}/{{$cities->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.WhoWeAre') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.add')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.product_adtional_info1')}}</a></li>
          ...
          {!! Form::open(['url'=>url('admin/cities/'.$cities->id),'files'=>true,'method'=>'put','id'=>'save_from_data' ]) !!}
                <div class="tab-content">

        @include('Admin.cities.updattabs.add')
              @include('Admin.cities.updattabs.shipinginfo')
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/WhoWeAre/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
