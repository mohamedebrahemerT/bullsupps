 ...
 @push('js')
            <script type="text/javascript">
               ...
               $(document).on('click','.DELET_PRODUCT',function(){
                ...
                $.ajax({
              url:'{{ url('admin/DELET_PRODUCT/'.$withdrawFromTotalMoney->id ) }}',
              dataType:'json',
              type:'post',
              data:{
                _token:'{{ csrf_token()  }}'
          ...
          $('.DELET_PRODUCT1').html('<h1>'+data.message+'</h1>');
             ...
             $(document).on('click','#save_from_data1',function(){
              ...
              url:'{{ url('admin/withdrawFromTotalMoney/'.$withdrawFromTotalMoney->id) }}',
              dataType:'json',
              type:'post',
              data:From_data,
              beforeSend:function(){
...
<br> <div class="clearfix"> </div>
        ...
        <div class="alert alert-danger sucess_danger hidden">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.withdrawFromTotalMoney')}}</a></li>
   ...
   {!! Form::open(['url'=>url('admin/withdrawFromTotalMoney/'.$withdrawFromTotalMoney->id),'files'=>true,'method'=>'put','id'=>'save_from_data' ]) !!}
  ...
  <div class="tab-content">
          ...
          @include('Admin.withdrawFromTotalMoney.tabs.product_info')
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {{trans('admin.productNAme_is') }}:{{ $withdrawFromTotalMoney->title  }}
      </div>
      <div class="modal-footer">
          <a href="{{url('admin/withdrawFromTotalMoney') }}">  <button type="button" class="btn btn-default" >{{trans('admin.leave') }}</button>
            </a>
      </div>
    </div>
