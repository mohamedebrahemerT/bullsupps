...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/BannerTop')}}/{{$BannerTop->id}}',
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.BannerTop') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/BannerTop','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

 
         
        
          @include('Admin.BannerTop.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/BannerTop/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
