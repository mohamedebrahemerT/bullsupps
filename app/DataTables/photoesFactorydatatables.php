...
class photoesFactorydatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.photoesFactory.btn.edit')

         ->addColumn('delete', 'Admin.photoesFactory.btn.delete')

         ->addColumn('checkbox', 'Admin.photoesFactory.btn.checkbox')
    ...
    public function query(photoesFactory $model)

    {

        return photoesFactory::query();
